...
namespace WR.WCF.Site
{
    ...
    {
        private void DebugLog(string methodName, bool isStop)
        {
            string info = string.Empty;

            if (!isStop)
                info = string.Format("MethodName:{0} start at {1:HH:mm:ss}", methodName, DateTime.Now);
            else
                info = string.Format("MethodName:{0} stop at {1:HH:mm:ss}", methodName, DateTime.Now);
        ...
        public List<WMCLASSIFICATIONITEM> GetClassificationItem(string schemeid, string userid)
        {
            try
            {
                DebugLog("GetClassificationItem", false);
        ...
        public List<WmClassificationItemEntity> GetClassSummary(string resultid)
        {
            try
            {
                DebugLog("GetClassSummary", false);
                using (BFdbContext db = new BFdbContext())
                {
        ...
        public List<WmidentificationEntity> GetIdentification(string operatorid, string fromday, string today, string done)
        {
            try
            {
                DebugLog("GetIdentification", false);
                using (BFdbContext db = new BFdbContext())
                {
                    //a.identificationid,
            ...
            try
            {
                ...
                using (BFdbContext db = new BFdbContext())
                {
                    ...
                    string sql = string.Format(@"select a.id,a.passid,a.inspid,a.modifieddefect,a.inspclassifiid,a.imagename,a.area_,d.color,
                                                    ...
                                                    where a.passid=b.passid and a.inspid=b.inspid and b.inspid=c.inspid and a.inspclassifiid=d.itemid 
        ...
        {
            DebugLog("UpdateClassificationItemUser", false);
            using (BFdbContext db = new BFdbContext())
            {
        ...
        public int UpdateDefect(string resultid, string checkedby, string mclassid, string finish)
        {
            ...
            using (BFdbContext db = new BFdbContext())
            {
                sbt.AppendFormat(@"select a.resultid,a.checkeddate,b.yieldnum,c.defectnum from wm_waferresult a, 
                                ...
                                (select ta.resultid,count(ta.id) defectnum  from wm_defectlist ta group by ta.resultid) c
                                where a.dielayoutid=b.layoutid and a.resultid=c.resultid and a.resultid='{0}'", resultid);
        ...
        public WMWAFERRESULT GetWaferResultById(string id)
        {
            try
            {
                DebugLog("GetWaferResultById", false);
                using (BFdbContext db = new BFdbContext())
                {
        ...
        public WMDIELAYOUT GetDielayoutById(string id)
        {
            try
            {
                DebugLog("GetDielayoutById", false);
                using (BFdbContext db = new BFdbContext())
                {
        ...
        public List<WmdielayoutlistEntitiy> GetDielayoutListById(string id)
        {
            try
            {
                DebugLog("GetDielayoutListById", false);
                using (BFdbContext db = new BFdbContext())
                {
                    string sql = string.Format(@"select t.dieaddressx,t.dieaddressy,t.inspclassifiid,t.isinspectable,a.columns_,a.rows_,t.disposition from wm_dielayoutlist t,wm_dielayout a
        ...
        {
            DebugLog("GetDensityReport", false);
            using (BFdbContext db = new BFdbContext())
            {
        ...
        {
            DebugLog("GetCountInspected", false);
            using (BFdbContext db = new BFdbContext())
            {
        ...
        {
            DebugLog("GetCategoryReport", false);
            using (BFdbContext db = new BFdbContext())
            {
        ...
        {
            DebugLog("GetDefectiveDieReport", false);
            using (BFdbContext db = new BFdbContext())
            {
        ...
        {
            DebugLog("GetDieInspDieReport", false);
            using (BFdbContext db = new BFdbContext())
            {
        ...
        {
            DebugLog("GetDefectListReport", false);
            using (BFdbContext db = new BFdbContext())
            {
        ...
        {
            DebugLog("GetGoodDieReport", false);
            using (BFdbContext db = new BFdbContext())
            {
        ...
        public List<WMCLASSIFICATIONITEM> GetClassificationItemsByLayer(string lot, string stDate, string edDate)
        {
            try
            {
                DebugLog("GetClassificationItemsByLayer", false);
                using (BFdbContext db = new BFdbContext())
                {
                    if (lot.EndsWith("|||"))
        ...
        public List<WMCLASSIFICATIONITEM> GetClassificationItemsByLot(string lot, string stDate, string edDate)
        {
            try
            {
                DebugLog("GetClassificationItemsByLot", false);
                using (BFdbContext db = new BFdbContext())
                {
                    return db.SqlQuery<WMCLASSIFICATIONITEM>(string.Format(@"select a.*
                                                                              from wm_classificationitem a
        ...
        public List<WmItemsSummaryEntity> GetItemsSummaryByLot(string lot, string stDate, string edDate)
        {
            try
            {
                DebugLog("GetItemsSummaryByLot", false);
                using (BFdbContext db = new BFdbContext())
                {
                    string sql = "";
        ...
        public List<WmItemsSummaryEntity> GetDefectSummaryByLot(string lot, string stDate, string edDate)
        {
            try
            {
                DebugLog("GetDefectSummaryByLot", false);
                using (BFdbContext db = new BFdbContext())
                {
                    string sql = "";
        ...
        public List<WmClassificationItemEntity> GetBaseClassificationItem()
        {
            try
            {
                DebugLog("GetBaseClassificationItem", false);
                using (BFdbContext db = new BFdbContext())
                {
