...
namespace WR.Client.UI
{
    public partial class frm_preview : FormBase
    {
        ...
        private void frm_preview_Load(object sender, EventArgs e)
        {
            ...
            {
                Resultid = Oparams[0];
                lblWaferID.Text = string.Format("Lot:{0}  Wafer:{1}", Oparams[1], Oparams[2]);
            }
        ...
        private void tlsPsample_Click(object sender, EventArgs e)
        {
            ...
            SaveResultid(Resultid, ent.LOT, ent.SUBSTRATE_ID);
            lblWaferID.Text = string.Format("Lot:{0}  Wafer:{1}", ent.LOT, ent.SUBSTRATE_ID);
        ...
        private void SaveResultid(string id, string lot, string substrate)
        {
            frm_main frm = this.Tag as frm_main;
            if (frm != null)
                frm.Oparams = new string[] { id, lot, substrate };
        }
        ...
        private string GetModifyDefect()
        {
            ...
            {
                sbt.AppendFormat(";{0},{1},{2},{3}", item.Id, item.PASSID, item.INSPID, item.InspclassifiId);
            }
